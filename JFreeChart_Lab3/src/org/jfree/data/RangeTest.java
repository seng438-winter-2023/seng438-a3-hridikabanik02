...
public class RangeTest {
    ...
    public void testIntersectRange(){
    	...
    	assertFalse(" Does -7.0 to 4.0 intersect for (-5.0, 10.0) is: ", exampleRange3.intersects(exampleRange4));
...
// tests expand.
    ...
    public void TestExpandNegetive() {
    	...
    	Range RangeAnswer = new Range(-5.0, 11.0);
...
public void testequals(){
	...
	assertEquals(" test for equal: ", temp1,exampleRange4.equals(temp1));
